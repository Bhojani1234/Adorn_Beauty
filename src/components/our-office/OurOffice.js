        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-md-6 mt-4 mt-lg-0 mt-xl-0">
            <div
              ...
              style={{
                background:
                  "url('/Rectangle 194 (1).png')no-repeat center center / cover",
              }}
            >
              <div className="office-content text-center p-4">
                <span className="office-overlay"></span>
          ...
          <div className="col-lg-3 col-md-6 mt-4 mt-lg-0 mt-xl-0">
            <div
              ...
              style={{
                background:
                  "url('/Rectangle 194 (2).png')no-repeat center center / cover",
              }}
            >
              <div className="office-content text-center p-4">
                <span className="office-overlay"></span>
          ...
          <div className="col-lg-3 col-md-6 mt-4 mt-lg-0 mt-xl-0">
            <div
              ...
              style={{
                background:
                  "url('/Rectangle 194.png')no-repeat center center / cover",
              }}
            >
              <div className="office-content text-center p-4">
                <span className="office-overlay"></span>
